/* font.h - 8x8 bitmap font (ASCII 32-126) */
#ifndef FONT_H
#define FONT_H
...
const unsigned char font8x8[95][8] = {
    ...
    {0x08,0x1E,0x28,0x1C,0x0A,0x3E,0x08,0x00}, // $
    ...
    {0x00,0x18,0x18,0x7E,0x18,0x18,0,0x00}, // +
    ...
    {0x1C,0x36,0x30,0x7C,0x30,0x30,0x7E,0x00}, // a
    {0x00,0x00,0x3C,0x06,0x3E,0x66,0x3E,0x00}, // b
    {0x00,0x60,0x60,0x7C,0x66,0x66,0x7C,0x00}, // c
    {0x00,0x06,0x06,0x3E,0x66,0x66,0x3E,0x00}, // d
    {0x00,0x36,0x36,0x7C,0x60,0x60,0x7C,0x00}, // e
    {0x1C,0x36,0x30,0x78,0x30,0x30,0x30,0x00}, // f
    {0x00,0x3E,0x66,0x66,0x3E,0x06,0x06,0x00}, // g
    {0x00,0x66,0x66,0x66,0x7E,0x66,0x66,0x00}, // h
    ...
    {0x3C,0x18,0x18,0x18,0x18,0x18,0x18,0x18}, // l
    ...
    {0x00,0x7C,0x66,0x66,0x7C,0x70,0x60,0x00}, // r
    ...
    {0x00,0x7E,0x06,0x0C,0x18,0x30,0x7E,0x00}, // z
